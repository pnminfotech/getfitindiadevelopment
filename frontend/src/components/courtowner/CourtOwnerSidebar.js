    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed top-4 left-4 z-[9999] bg-[#0d2149] text-white p-2 rounded-md lg:hidden"
        >
          <FaBars size={20} />
        </button>
      )}
      ...
      {/* ---- Sidebar ---- */}
      <aside
        className={`fixed top-0 left-0 w-64 bg-[#1c2331] text-white h-screen flex flex-col justify-between shadow-2xl transform transition-transform duration-300 z-50 
